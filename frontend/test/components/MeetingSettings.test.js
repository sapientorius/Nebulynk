...
describe('static source contract: MeetingSettings source contract', () => {
  it('contains all meeting-related platform settings and saves them together', () => {
    ...
    expect(source).toContain('data-testid="meeting-recording-retention-info"')
    expect(source).toContain('data-testid="meeting-recording-retention-unlimited"')
    expect(source).toContain('data-testid="meeting-recording-retention-days"')
    expect(source).toContain('data-testid="meeting-recording-storage-unlimited"')
    expect(source).toContain('data-testid="meeting-recording-storage-limit-gib"')
    ...
    expect(source).toContain('recordingRetentionDays: 60')
    expect(source).toContain('recordingStorageLimitGiB: 10')
    ...
    expect(source).toContain('meetingRecordingRetentionDays')
    expect(source).toContain('meetingRecordingStorageLimitGiB')
