/**
 * English Presence simulator for Nebulynk demo data.
 *
 ...
 *   - English demo database must be seeded (npm run seed:demo:en)
 *
 * Usage:
 *   node scripts/simulate-presence-en.mjs
 *
...
async function main() {
  console.log('=========================================')
  console.log('  Nebulynk English Presence Simulator')
  console.log('=========================================')
  console.log()
  ...
  try {
    ...
    console.error('[presence] Make sure the backend is running and the English demo DB is active.')
    process.exit(1)
  }
