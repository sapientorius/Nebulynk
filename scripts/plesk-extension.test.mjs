...
test('registers both Plesk Nginx hook variants and keeps domain routing scoped', async () => {
  ...
  assert.match(actionFormSection, /'cancelTitle' => 'Cancel'/)
  ...
  assert.match(cleanupFormSection, /'cancelTitle' => 'Cancel'/)
  ...
  assert.match(controller, /'cancelTitle' => 'Cancel'/)
  ...
  assert.match(view, /<details class="form-box nebulynk-card nebulynk-output-card">/)
  assert.match(view, /<summary class="nebulynk-output-summary">/)
})
